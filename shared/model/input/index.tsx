...
import {
  ...
  FileInputProps,
  SelectOption,
} from "../../config/type/InputWrapperProps";
...
import {
  ...
  buildInputClass,
  buildLabelClass,
} from "../../config/theme/inputTokens";
import { InputWrapper } from "../../ui/InputWrapper";
import { useAutoResize } from "../useAutoReisze";
import { UploadIcon } from "lucide-react";
import { GenericInput } from "../../ui/GenericInput";

export const TextInput = forwardRef<HTMLInputElement, TextInputProps>(
  function TextInput(props, ref) {
    return <GenericInput ref={ref} {...props} />;
  },
);
        ...
        >
          <input
            ...
            className={cn(
              ...
              "dark:border-slate-600  dark:checked:bg-violet-500",
          ...
          return (
            ...
            >
              <input
                ...
                className={cn(
                  "shrink-0 mt-0.5 border-slate-300 text-violet-600",
                  "focus:ring-2 focus:ring-violet-500/30 focus:ring-offset-1",
                  "dark:border-slate-600  dark:checked:bg-violet-500",
